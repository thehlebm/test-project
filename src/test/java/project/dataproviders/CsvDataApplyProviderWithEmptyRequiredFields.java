...
public class CsvDataApplyProviderWithEmptyRequiredFields implements ArgumentsProvider {
    public static final String TEST_CSV = "testdata/testdata-emptyrequired.csv";

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        List<Map<String, String>> dataList = FileUtils.getCsvFromResources(TEST_CSV);
