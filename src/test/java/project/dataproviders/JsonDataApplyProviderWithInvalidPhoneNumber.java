...
public class JsonDataApplyProviderWithInvalidPhoneNumber implements ArgumentsProvider {
    public static final String JSON_FILE_PHONE_NUMBERS = "testdata/testdata-invalidphone.json";

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws IOException {
        String userJsonString = FileUtils.readFromResourceFileAsString(JSON_FILE_PHONE_NUMBERS);
