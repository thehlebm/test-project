...
public class CsvDataApplyProviderWithEmptyFileField implements ArgumentsProvider {
    public static final String TEST_CSV_PATH = "testdata/testdata-emptyfile.csv";
    @Override
